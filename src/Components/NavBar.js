        ...
        <nav className={isMobile ? "nav-bar nav-mobile" :"nav-bar" }>
                <ul className="links-container">
                    ...
                    <li className="link-to link-to-desktop">
                        ...
                        <ul className="section-container">
                            <li className="section"><div className="link-button"><a href="https://zelayagonzalo.github.io/priconne-tierlist" target="_blank" rel="noreferrer">Tierlist<i className="fas fa-external-link-alt"></i></a></div></li>
